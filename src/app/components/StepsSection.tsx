...
export function StepsSection() {
  ...
  return (
    <section aria-labelledby="steps-title" style={{ background: C.white, padding: "5rem 4rem" }}>
      ...
      <div aria-live="polite" style={{ marginTop: "1.25rem", maxWidth: 640 }}>
        ...
        <div style={{ height: 8, background: "rgba(65,90,119,0.2)", borderRadius: 999, overflow: "hidden" }}>
          <div
            style={{
              height: "100%",
              width: `${progress}%`,
      ...
      <ol className="flex flex-col gap-3 mt-10" style={{ listStyle: "none", padding: 0, marginBottom: 0 }}>
        {steps.map((step, i) => (
          <li
            ...
            style={{
              background: C.sand,
              border: activeStep === i ? "1px solid rgba(65,90,119,0.45)" : "0.5px solid rgba(65,90,119,0.25)",
              ...
              boxShadow: activeStep === i ? "0 8px 24px rgba(27,38,59,0.08)" : "none",
            }}
          >
